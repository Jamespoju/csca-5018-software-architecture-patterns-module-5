...
//        name = "registration-request-exchange",
        name = "registration-request-exchange-consistent-hash-final",
...
//    val registrationRequestQueue = RabbitQueue("registration-request")
    val registrationRequestQueue = RabbitQueue(System.getenv("QUEUE_NAME") ?: "registration-request-1")
...
//    connectionFactory.declareAndBind(exchange = registrationRequestExchange, queue = registrationRequestQueue, routingKey = "42")
    connectionFactory.declareAndBind(exchange = registrationRequestExchange, queue = registrationRequestQueue, routingKey = "1")
